export function renderScreen3(pitch, category, renderScreen4) {
    ...
    // elon_score = generateScore("Elon Musk", elon) 
    // beyonce_score = generateScore("Beyonce", beyonce)  
    // warren_score = generateScore("Warren Buffett", warren)  
    // mark_score = generateScore("Mark Cuban", mark)
    // serena_score = generateScore("Serena Williams", serena)
